...
def _gdn_attention_core_xpu_impl(
    ...
    # Slice to the actual count (mirrors gdn_linear_attn.py:803-808 on the
    # CUDA path); slicing dim 0 of contiguous tensors yields contiguous
    # views that share storage with the originals.
