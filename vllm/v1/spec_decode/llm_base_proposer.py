...
class SpecDecodeBaseProposer:
    ...
    def prepare_inputs_padded(
        ...
        spec_common_attn_metadata = CommonAttentionMetadata(
            ...
            seq_lens_cpu_list=common_attn_metadata.seq_lens_cpu_list,
            query_lens_cpu_list=common_attn_metadata.query_lens_cpu_list,
            num_reqs=common_attn_metadata.num_reqs,
    ...
    def prepare_inputs(
        ...
        spec_common_attn_metadata = CommonAttentionMetadata(
            ...
            seq_lens_cpu_list=new_seq_lens_cpu.tolist(),
            query_lens_cpu_list=new_num_tokens_per_req_np.tolist(),
            num_reqs=common_attn_metadata.num_reqs,
            num_actual_tokens=total_num_tokens,
            max_query_len=new_query_len_per_req.max().item(),
