...
class SchedulerOutput:
    ...
    # Recurrent block IDs are local to independent physical pools, so their
    # owning cache group must remain attached through worker-side zeroing.
