...
def _check_kvarn_beta_unsupported_config(
    ...
    if vllm_config.speculative_config is not None:
        ...
        if not (
            ...
            raise ValueError(
                ...
                "compact K4V4 draft cache (or BF16 draft for compact K4V2), "
                "BF16 compute, TP1/PP1, "
    ...
    if vllm_config.model_config.is_multimodal_model and not language_model_only:
        ...
        if (
            multimodal_config is None
            or multimodal_config.get_limit_per_prompt("video") != 0
        ):
            raise ValueError(
